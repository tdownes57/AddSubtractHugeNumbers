...
Module modUtilities
    ...
    Public Function InsertCommasForTriplets(par_inputNumber As String) As String
        ''
        ''Added 6/25/2019 td
        ''
        ''Formerly named "AddCommasForTriplets".  The "Add" prefix is confusing.  ----7/15/2019 td
        ''
    ...
    End Function ''End of "Public Function InsertCommasForTriplets(par_inputNumber As String) As String""
